...
import {
  Toolbar, Table, TableBody, TableCell, TablePagination,
  TableContainer, TableHead, TableRow, Paper
} from '@material-ui/core'

import { Patient, Address } from '@the-patients-crud/common/types/entities'
import { PatientsDataList } from '../../types/user'
